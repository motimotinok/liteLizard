# LiteLizard 仕様アーカイブ v001（旧仕様統合）

最終更新: 2026-02-17

このファイルは旧仕様の統合アーカイブです。履歴参照専用であり、実装の優先参照先ではありません。
現行の優先仕様は `LiteLizard_spec_v002.md` を参照してください。

---

## 統合元 1: `LiteLizard_requirements.md`
...
## 統合元 2: `LiteLizard_clean_spec_v1.md`
...
## 統合元 3: `LiteLizard_implementation_design.md`
